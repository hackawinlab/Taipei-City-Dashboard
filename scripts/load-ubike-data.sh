...
echo "==> [2/5] Seeding ${MANAGER_DB} (timemap + shortage blocks + shortage timeline + Youbike Analysis dashboard)"
...
psql_db "${MANAGER_DB}" -q < "${REPO_ROOT}/db-sample-data/youbike-shortage-timeline-seed.sql"
