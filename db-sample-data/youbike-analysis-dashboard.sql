-- "Youbike Analysis" dashboard tab
-- Adds one dashboard per city (taipei + metrotaipei) so the sidebar shows
-- a "Youbike Analysis" tab under each city section.
-- Idempotent: safe to re-run.

-- 1. Dashboards (one per city, both named "Youbike Analysis")
...
VALUES
  ('youbike-analysis-taipei',      'Youbike Analysis', '{1,60,217,213}', 'pedal_bike', NOW(), NOW()),
  ('youbike-analysis-metrotaipei', 'Youbike Analysis', '{1,60,217,213}', 'pedal_bike', NOW(), NOW())
