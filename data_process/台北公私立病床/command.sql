...
INSERT INTO public.bed_count_newtaipei (
		...
		chronic_beds,
		acute_general_beds,
		psychiatric_acute_general_beds,
		chronic_general_beds,
		psychiatric_chronic_general_beds,
		chronic_tb_beds,
		hansen_beds,
		international_medical_beds,
		icu_beds,
		burn_beds,
		infant_beds,
		emergency_observation_beds,
		other_observation_beds,
		palliative_beds,
		chronic_respiratory_care_beds,
		subacute_respiratory_care_beds,
		acute_tb_beds,
		psychiatric_icu_beds,
		post_surgery_recovery_beds,
		infant_cots,
		hemodialysis_beds,
		burn_icu_beds,
		general_isolation_beds,
		positive_pressure_isolation_beds,
		negative_pressure_isolation_beds,
		bone_marrow_transplant_beds,
		criminal_treatment_beds,
		peritoneal_dialysis_beds,
		post_acute_care_beds,
		integrated_emergency_transfer_beds,
		guarded_beds,
		forensic_psychiatric_beds
	)
VALUES (data);
-- 步驟 4：新增台北資料
...
VALUES (
		...
		SELECT district_name AS x_axis,
			year AS y_axis,
			total_beds AS data
		FROM public.bed_count_taipei
		UNION ALL
		SELECT district_name AS x_axis,
			year AS y_axis,
			total_beds AS data
		FROM public.bed_count_newtaipei
		ORDER BY x_axis,
			y_axis;
$$,
NULL,
